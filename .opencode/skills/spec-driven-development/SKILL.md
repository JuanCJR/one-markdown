...
description: >-
  Método SDD - nada se implementa sin especificación versionada. Úsala antes de
  planificar cualquier feature, épica o cambio significativo; al escribir,
  corregir o revisar una spec; y al decidir si un cambio es major, minor o
  patch. Define los cuatro documentos por feature, el versionado semántico, las
  reglas de redacción que hacen que un criterio se pueda desmentir, y cuánta
  especificación conviene escribir por adelantado.
metadata:
  origin: one-markdown
