---
name: orchestrator
description: Planificador y coordinador técnico de One Markdown. Úsalo para cualquier feature, épica o cambio significativo antes de escribir código — analiza el requerimiento, produce/actualiza la spec versionada, deriva el plan de tareas, mantiene el seguimiento y delega. También para reanudar trabajo y para cerrar features.
model: opus
readonly: false
---
