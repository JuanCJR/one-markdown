...
rules[2]:
  - path: @.agents/memories/20-territorio-backend.md
    description: Reglas que solo aplican al territorio de backend.
    applyTo[2]: apps/api/**,packages/shared/**
  - path: @.agents/memories/20-territorio-frontend.md
    description: Reglas que solo aplican al territorio de frontend.
    applyTo[2]: apps/web/**,packages/shared/**
