 ...
 */
const PREVIEW_CLASS = [
  'max-w-none text-tinta',
  '[&_h1]:mt-6 [&_h1]:mb-3 [&_h1]:text-2xl [&_h1]:font-semibold [&_h1]:text-tinta',
  '[&_h2]:mt-6 [&_h2]:mb-2 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-tinta',
  '[&_h3]:mt-5 [&_h3]:mb-2 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-tinta',
  '[&_p]:my-3 [&_p]:leading-relaxed',
  '[&_ul]:my-3 [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:my-3 [&_ol]:list-decimal [&_ol]:pl-6',
  '[&_li]:my-1 [&_li.task-list-item]:list-none [&_li.task-list-item]:-ml-6',
  '[&_a]:text-tinta [&_a]:underline [&_a]:underline-offset-2',
  '[&_blockquote]:my-3 [&_blockquote]:border-l-4 [&_blockquote]:border-hair-control',
  '[&_blockquote]:pl-4 [&_blockquote]:text-tinta-secundaria',
  '[&_code]: [&_code]:bg-sup-hundida [&_code]:px-1 [&_code]:py-0.5 [&_code]:font-mono',
  '[&_code]:text-[0.9em]',
  '[&_pre]:my-3 [&_pre]:overflow-x-auto [&_pre]: [&_pre]:bg-tinta [&_pre]:p-4',
  '[&_pre]:text-sm [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_pre_code]:text-sup-base',
  '[&_hr]:my-6 [&_hr]:border-hair-fila',
  '[&_img]:max-w-full',
  '[&_table]:my-3 [&_table]:block [&_table]:w-full [&_table]:overflow-x-auto',
  '[&_table]:border-collapse [&_table]:text-sm',
  '[&_th]:border [&_th]:border-hair-control [&_th]:bg-sup-hundida [&_th]:px-3 [&_th]:py-1.5',
  '[&_th]:text-left [&_th]:font-semibold',
  '[&_td]:border [&_td]:border-hair-control [&_td]:px-3 [&_td]:py-1.5',
].join(' ');
